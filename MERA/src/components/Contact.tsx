...
const contactMethods = [
  {
    icon: Mail,
    label: "Email",
    value: "dev.nitinworktime@gmail.com",
    href: "mailto:dev.nitinworktime@gmail.com",
  },
  {
    icon: Github,
    label: "GitHub",
    value: "@CodeWithNitin-Dev369",
    href: "https://github.com/CodeWithNitin-Dev369",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "NITINTIWARI",
    href: "https://linkedin.com/in/CodeWithNitin",
  },
];
